class Flacoai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Roura-io/flaco/releases/download/v0.8.2/flaco-0.8.2-arm64-apple-darwin.tar.gz"
      sha256 "866d1617c6d11f99235f097f0ab1c0e19b2ed526a8bacd7f15dc4b968b5f533b"
    end
  end
