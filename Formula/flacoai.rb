class Flacoai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Roura-io/flaco/releases/download/v0.7.0/flaco-0.7.0-arm64-apple-darwin.tar.gz"
      sha256 "ec4b7bf0d84285311701043fd41833749b8874bb3e77ff1630c2ce5b7be8bc69"
    end
  end
