class Flacoai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Roura-io/flaco/releases/download/v0.9.1/flaco-0.9.1-arm64-apple-darwin.tar.gz"
      sha256 "8fee9fd96da59091c553f173db28306afd918c93fe89266efeeb6aaa546261e9"
    end
  end
