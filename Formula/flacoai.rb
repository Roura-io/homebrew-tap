class Flacoai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Roura-io/flaco/releases/download/v0.8.0/flaco-0.8.0-arm64-apple-darwin.tar.gz"
      sha256 "aca0e05a4d79b2ab4088262270720cef6ed13ade9ba0c1feea700f0fe4d2fb46"
    end
  end
