class Flacoai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Roura-io/flaco/releases/download/v0.6.0/flaco-0.6.0-arm64-apple-darwin.tar.gz"
      sha256 "2f06d9d8a3f7f2701d4ae70bfb8ced641f179b54aac1849a69da9c7e147a1251"
    end
  end
